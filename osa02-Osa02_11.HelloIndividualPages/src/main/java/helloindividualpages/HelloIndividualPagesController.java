...
public class HelloIndividualPagesController {
    ...
    public String getPage(Model model, @PathVariable String identifier){
        System.out.println(this.items.get(identifier));
        model.addAttribute("item", this.items.get(identifier));
        return "Single";
    }
